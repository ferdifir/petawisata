...
<div class="w-full">
    ...
    @endif
    <form action="{{ route('ajukan.wisata.store') }}" method="POST" enctype="multipart/form-data" class="mt-4 bg-primary-bg p-8 flex gap-40 w-full">
        @csrf
        <div class="w-full">
        ...
        <div class="w-full">
            <div class="w-full flex flex-col mb-8">
                ...
                <select name="category" class="px-3 py-2 border border-primary-font focus:ring-1 focus:ring-primary-font outline-none rounded-md" required value="{{ old('category') }}">
