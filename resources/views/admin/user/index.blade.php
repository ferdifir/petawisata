...
@section('content')
    ...
    <div class="w-full mt-8">
        <table class="w-full rounded-md mb-8" id="userTable">
            <thead>
            ...
            <tbody class="border border-primary-font text-primary-font font-medium">
                ...
                @foreach ($user as $u)
                    <tr class="h-full">
                        ...
                        <td class="px-4 py-3">{{ $u->alamat }}</td>
                        <td class="px-4 py-3">{{ $u->no_hp }}</td>
                        <td class="flex items-center justify-center h-full px-4 py-3 gap-2">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-id="{{ $u->id }}" data-name="{{ $u->name }}" id="hapus">
...
@section('script')
    <script>
        ...
        $('#userTable').on('click', '.hapus', function() {
            Swal.fire({
